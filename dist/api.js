(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ApiJS", [], factory);
	else if(typeof exports === 'object')
		exports["ApiJS"] = factory();
	else
		root["ApiJS"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ng_api = __webpack_require__(7);
	
	var _ng_api2 = _interopRequireDefault(_ng_api);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	module.exports = { BaseApi: _base_api2.default, NgApi: _ng_api2.default };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultHandlers = {
	  ...
	  login: function login() {
	    return this._reject('Cannot log in while ' + this.state);
	  },
	
	  signup: function signup() {
	    return this._reject('Cannot sign up while ' + this.state);
	  },
	  ...
	  logout: function logout() {
	    ...
	    return this._logout().catch(function (x) {
	      ...
	      return _this.transition('logged_out');
	    });
	  },
	...
	function waitingState(name) {
	  return Object.assign({}, defaultHandlers, {
	    _onEnter: function _onEnter() {
	      ...
	      this._Promise.all(this._waiting_for).then(function () {
	...
	module.exports = _machina2.default.Fsm.extend({
	  ...
	  validateLoadState: function validateLoadState(state) {
	    ...
	    logged_out: Object.assign({}, defaultHandlers, {
	      ...
	      login: function login() {
	        ...
	        return this._login.apply(this, arguments).then(function (res) {
	          if (res && res.success === false) {
	            return _this3._reject(res);
	          } else {
	            _this3.data = res;
	
	            _this3.emit('api_data_changed', res);
	            _this3.transition('logging_in');
	            return res;
	          }
	        }).catch(function (x) {
	          console.log('FAIL: ', x);
	          _this3.transition('logged_out');
	          return _this3._reject(x);
	        });
	      },
	      ...
	      signup: function signup() {
	        ...
	        return this._signup.apply(this, arguments).then(function (res) {
	          _this4.data = res;
	          _this4.emit('api_data_changed', res);
	          _this4.transition('signing_up');
	          return res;
	        }).catch(function (x) {
	          _this4.transition('logged_out');
	          return _this4._reject(x);
	        });
	      },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var libMachina = window.machina;
	
	if (!libMachina) {
	  libMachina = __webpack_require__(3);
	}
	
	exports.default = libMachina;
	...
	var NgHttpApi = _base_api2.default.extend({
	  ...
	  _procHttpResponse: function _procHttpResponse(promise) {
	    ...
	    return promise.then(function (res) {
	      if (res.data.errors) {
	        return _this._Promise.reject({ type: _this.ERROR_VALIDATION_FAILED, data: res.data.errors });
	      } else if (res.data.success == false) {
	        return _this._Promise.reject({ type: _this.ERROR_AUTHENTICATION_FAILED, message: 'Login incorrect - try again.' });
	      } else {
	        return res.data;
	      }
	    }).catch(function (x) {
	      ...
	      return _this._Promise.reject(res);
	    });
	  },
	
	  delete: function _delete(relativeUrl, deleteData) {
	    return this._$http({ method: 'DELETE',
